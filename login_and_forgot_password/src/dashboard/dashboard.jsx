    ...
    return (
        ...
        <div className="w-full bg-[#F8F9FA] text-black flex-1 h-screen overflow-y-auto">
            ...
            <div className="flex border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)]  justify-around items-center py-2">
               ...
               <div className="bg-white flex flex-row justify-center items-center gap-2 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] p-2 border-gray-200 border">
                    <img src={calenderIcon} alt="calendar" className="h-4 w-4" />
                    <p>01/06/2026 - 30/06/2026</p>
                </div> 


                <button className="bg-white hover:cursor-pointer p-2 rounded-lg flex justify-around items-center gap-2 hover:bg-[#f3f0f0] border-gray-200 border shadow-[0_1px_3px_rgba(0,0,0,0.12)]">
                    <img src={yearlyReport} alt="calendar" className="h-4 w-4 " />
                    Yearly Report
                </button> 


                <button className="text-white bg-orange-500 hover:cursor-pointer hover:bg-orange-700 p-2 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border-gray-200 border">
                    Add New
                </button>
            ...
            <div className="flex justify-rows h-120">
                <div className="flex w-[70%] flex-col mt-8">
                    {/* EMPLOYEE BOX */}
                    <div className="bg-white border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-60 rounded-lg p-2 ml-10">
                    ...
                    <div className="bg-white border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg h-45 mt-7 p-2 ml-10 ">
                        <div className=" w-full border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-11 flex items-center rounded-lg px-3 justify-between border-l-orange-500 border-l-4">
                        <p className="text-base w-45 font-bold">Leave Type Distribution</p>
                ...
                {/* OVERVIEW STATISTICS */}
                <div className="border bg-white border-gray-200 ml-10 mt-8 w-full mr-10 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.12)] px-4 py-2">
                    ...
                    <div className="flex mt-7">
                        {/* TOTAL EMPLOYEE BOX */}
                       <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] w-[50%] mr-4 rounded-lg h-40 p-2">
                        <div className="p-2 flex flex-col gap-1">
                            <div className="flex gap-2 items-center">
                                <img src={totalEmployeeGraph} alt="Home" className="h-11 w-11 rounded-full"/>
                                <span className="text-lg font-bold text-gray-500">Total Employess</span>
                            </div>
                            <div className="flex items-center justify-between mr-3">
                                <span className="text-3xl ml-1 font-bold pt-2">1,848</span>
                                <div className="flex mt-2 px-3 py-1.5 border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] bg-[#f3f0f0] border rounded-2xl gap-2 items-center"> 
                                    <span> +18% </span>
                                    <img src={increaseIcon} alt="inc" className="h-5 w-5 rounded-full rotate-35"/>
                                </div>
                            </div>
                            <span className="text-gray-500 mt-0.5 ml-1">Headcount Overview</span>
                        </div>
                        </div>

                       {/* NEW JOINEE BOX */}
                       <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] w-[50%] ml-4 rounded-lg p-2">
                        <div className="p-2 flex flex-col gap-1">
                            <div className="flex gap-2 items-center">
                                <img src={newJoineesGraph} alt="Home" className="h-11 w-11 rounded-full"/>
                                <span className="text-lg font-bold text-gray-500">New Joinees</span>
                            </div>
                            <div className="flex items-center justify-between mr-3">
                                <span className="text-3xl ml-1 font-bold pt-2">1,248</span>
                                <div className="flex mt-2 px-3 py-1.5 border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] bg-[#f3f0f0] border rounded-2xl gap-2 items-center"> 
                                    <span> +22% </span>
                                    <img src={increaseIcon} alt="inc" className="h-5 w-5 rounded-full rotate-35"/>
                                </div>
                            </div>
                            <span className="text-gray-500 mt-0.5 ml-1">All Department</span>
                        </div>
                       </div>
                    </div>  
                    <div className="flex mt-7">
                        ...
                        {/* LATE ARRIVAL BOX */}
                       <div className="border-gray-200 border shadow-[0_1px_3px_rgba(0,0,0,0.12)] w-[50%] mr-4 rounded-xl h-40 p-2">
                        <div className="p-2 flex flex-col gap-1">
                            <div className="flex gap-2 items-center">
                                <img src={lateArrivalsGraph} alt="Home" className="h-11 w-11 rounded-full"/>
                                <span className="text-lg font-bold text-gray-500">Late Arrivals Today</span>
                            </div>
                            <div className="flex items-center justify-between mr-3">
                                <span className="text-3xl ml-1 font-bold pt-2">12</span>
                                <div className="flex mt-2 px-3 py-1.5 border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] bg-[#f3f0f0] border rounded-2xl gap-2 items-center"> 
                                    <span> -16% </span>
                                    <img src={decreaseIcon} alt="inc" className="h-5 w-5 rounded-full rotate-[-35deg]"/>
                                </div>
                            </div>
                            <span className="text-gray-500 mt-0.5 ml-1">Delayed Logins Today</span>
                        </div>
                        </div>

                       {/* TOTAL PAYROLL BOX */}
                       <div className="border-gray-200 border shadow-[0_1px_3px_rgba(0,0,0,0.12)] w-[50%] ml-4 rounded-xl p-2">
                        <div className="p-2 flex flex-col gap-1">
                            <div className="flex gap-2 items-center">
                                <img src={totalPayroll} alt="Home" className="h-11 w-11 rounded-full"/>
                                <span className="text-lg font-bold text-gray-500">Total Payroll Cost</span>
                            </div>
                            <div className="flex items-center justify-between mr-3">
                                <span className="text-3xl ml-1 font-bold pt-2">$2.4M</span>
                                <div className="flex mt-2 px-3 py-1.5 border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] bg-[#f3f0f0] border rounded-2xl gap-2 items-center"> 
                                    <span> +16% </span>
                                    <img src={increaseIcon} alt="inc" className="h-5 w-5 rounded-full rotate-35"/>
                                </div>
                            </div>
                            <span className="text-gray-500 mt-0.5 ml-1">Payroll Outflow</span>
                        </div>
                       </div>
                    </div>  
                </div>
            ...
            {/* LATE ARRIVALS BOX */}
            <div className="flex h-140 mx-10 mt-5 ">
                <div className="bg-white h-120 w-[33%] my-0 border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg mr-5 p-2">
                    <div className=" w-full border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-11 flex items-center rounded-lg pl-3 px-3 justify-between border-l-orange-500 border-l-4">
                        <p className="text-base w-45 font-bold">Late Arrivals Today</p>
                        ...
                        <div className="flex flex-col mt-2 h-100 justify-evenly itmes-left gap-2">
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[19%] p-2 rounded-lg bg-[#f7f0f0] gap-0 flex flex-col">
                            ...
                            <div className="flex justify-between px-3">
                                <span className="ml-9">Customer Support</span>
                                <span className="text-red-500 bg-red-200 font-bold px-1 rounded-2xl">+45 min</span>
                            </div>                       
                        </div>
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[19%] p-2 rounded-lg bg-[#f7f0f0] gap-0 flex flex-col">
                            ...
                            <div className="flex justify-between px-3">
                                <span className="ml-9">HR Admin</span>
                                <span className="text-red-500 bg-red-200 font-bold  px-1 rounded-2xl">+55 min</span>
                            </div>                            
                        </div>
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[19%] p-2 rounded-lg bg-[#f7f0f0] gap-0 flex flex-col">
                            ...
                            <div className="flex justify-between px-3">
                                <span className="ml-9">Sales</span>
                                <span className="text-red-500 bg-red-200 font-bold px-1 rounded-2xl">+30 min</span>
                            </div> 
                        </div>
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[19%] p-2 rounded-lg bg-[#f7f0f0] gap-0 flex flex-col">
                            ...
                            <div className="flex justify-between px-3">
                                <span className="ml-9">Administration</span>
                                <span className="text-red-500 bg-red-200 font-bold  px-1 rounded-2xl">+20 min</span>
                            </div> 
                        </div>
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[19%] p-2 rounded-lg bg-[#f7f0f0] gap-0 flex flex-col">
                            ...
                            <div className="flex justify-between px-3">
                                <span className="ml-9">Finance</span>
                                <span className="text-red-500 bg-red-200 font-bold px-1 rounded-2xl">+42 min</span>
                            </div>
                        </div>
                ...
                <div className="h-120 w-[33%] my-0 mr-5 ">
                    <div className="flex flex-col">

                        {/* recruits box */}
                        <div className="mt-0 h-82 border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg bg-white p-2">
                            <div className=" w-full border border-gray-200 h-11 flex items-center rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] pl-3 px-3 justify-between border-l-orange-500 border-l-4">
                               <p className="text-sm w-45 font-bold">Recruitment Statistics</p>
                ...
                {/* Uppcoming Interviews */}
                <div className="bg-white h-120 w-[33%] my-0 border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg mr-0 p-2">
                    {/* HEAD */}
                    <div className=" w-full border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-11 flex items-center rounded-lg px-3 justify-between border-l-orange-500 border-l-4">
                        <p className="text-base w-45 font-bold">Upcoming Interview</p>
                    ...
                    <div className="flex flex-col bg-white h-[80%] gap-2 mt-2">
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[50%] p-2 rounded-lg flex flex-col">
                            <p className="ml-3 mt-3 font-bold text-xl">UI/UX Design Interview</p>
                            <span className="ml-3 text-[#a9a9a9] text-lg">12:00 PM - 01:50 PM</span>
                            <div className="flex gap-7 mt-11 ml-3">
                            <button className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-xl px-4 py-1 flex gap-2 hover:cursor-pointer hover:bg-orange-500 hover:text-white ">
                                <img src={calendar3Icon} alt="calendar-3" className="h-4 w-4 mt-1"/>
                                Add to Calendar
                            </button>
                            <button className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg px-4 py-1 bg-[#f3f0f0] flex gap-2 hover:cursor-pointer hover:bg-white">
                        ...
                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[50%] p-2 rounded-lg">
                            <p className="ml-3 mt-3 font-bold text-xl">Senior Developer React</p>
                            <span className="ml-3 text-[#a9a9a9] text-lg">03:00 PM - 04:00 PM</span>
                            <div className="flex gap-7 mt-11 ml-3">
                            <button className="border border-gray-200 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] px-4 py-1 flex gap-2 hover:cursor-pointer hover:bg-orange-500 hover:text-white">
                                <img src={calendar3Icon} alt="calendar-3" className="h-4 w-4 mt-1"/>
                                Add to Calendar
                            </button>
                            <button className="border border-gray-200 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] px-4 py-1 bg-[#f3f0f0] flex gap-2 hover:cursor-pointer hover:bg-white">
                                <img src={videoIcon} alt="join" className="h-4 w-4 mt-1"/>
                                Join Now
                            </button>
                            </div>
                    ...
                    <button className=" mt-2.5 w-[33%] border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-xl bg-[#f3f0f0] hover:cursor-pointer">View All →</button>
                </div>
            </div>


            <div className="flex h-120 mx-10 mt-0 ">


                <div className="h-100 w-[60%] my-0 mr-5">
                    <div className="flex flex-row gap-5">
                        ...
                        <div className="h-30 bg-white w-[50%] border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg flex items-center justify-center">
                            <div className="w-[60%] flex flex-col">
                                <p className="pl-3  text-[#808080]">Benefits Deductions</p>
                                <p className="text-3xl font-bold pl-3">$56K</p>
                                <p className="pl-3 pt-1 text-[#808080]">Insurance + 401(k)</p>
                            </div>
                            <div className="w-[40%]">
                        ...
                        <div className="h-30 bg-white w-[50%] border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg flex">
                            ...
                            <div className="w-[40%] flex flex-col items-center justify-begin my-2 gap-3">
                                <button className=" border border-gray-200 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] my-1 mx-2 flex items-center gap-1 hover:cursor-pointer hover:bg-[#f3f0f0] px-2 py-1">
                                <img src={calendar} alt="Home" className="h-4 w-4"/>
                                <span>Monthly</span>
                            </button>
                            <img src={salaryIcon} alt="Home" className="h-12 w-15"/>
                            </div>
                        </div>
                    </div>

                    {/* TOP EMPLOYESS BOX */}
                    <div className="h-65 bg-white w-full border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg p-2 mt-5">
                        <div className=" w-full border  border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-11 flex items-center rounded-lg pl-3 px-3 justify-between border-l-orange-500 border-l-4">
                ...
                <div className="bg-white h-100 w-[40%] my-0 border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg mr-0 p-3">
                    <div className=" w-full border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-11 flex items-center rounded-lg pl-3 px-3 justify-between border-l-orange-500 border-l-4">
                        <p className="font-bold">Pending Approvals</p>
                        <button className=" border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] rounded-lg p-1 bg-[#f3f0f0] hover:cursor-pointer hover:bg-white">View All</button>
                    </div>
                    <div className="flex flex-col mt-4 h-75 justify-between itmes-left gap-2 ">


                        <div className="border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-[33%] pt-2 rounded-xl pl-3">
                            <div className="flex">
                                <div className="w-[60%] flex flex-col">
                                ...
                                <div className="w-[40%] gap-3 flex h-[33%] justify-center mt-4">
                                    <button className="text-white bg-orange-400 rounded-lg  shadow-[0_1px_3px_rgba(0,0,0,0.12)] px-2 py-1 hover:cursor-pointer hover:bg-orange-500">Approve</button>
                                    <button className="bg-white text-orange-400 border-orange-400 border rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] px-2 py-1 hover:cursor-pointer hover:bg-orange-400 hover:text-white">Decline</button>
                                </div>
                            </div>
                        </div>
