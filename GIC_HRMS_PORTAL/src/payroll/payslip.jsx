            ...
            <div className="w-full bg-[#F8F9FA] text-black flex-1 h-screen overflow-y-auto">
                ...
                <div className="mx-2">
                    <div className="flex flex-col md:flex-row md:h-20 py-3 md:py-0">
                        <div className="md:w-[40%] pl-4 md:pl-7 flex flex-col py-2 md:py-5 justify-between">
                        ...
                        <div className="md:w-[60%] flex items-center gap-3 md:gap-4 justify-start md:justify-end mt-3 md:mt-0">
                            <button className="bg-black text-white rounded-lg py-2 px-3 shadow-[0_1px_3px_rgba(0,0,0,0.12)] flex items-center gap-1.5 hover:cursor-pointer hover:bg-[#f3f0f0] text-sm">
                ...
                {/* BODY */}
                <div className="my-5 rounded-lg bg-white h-auto mx-2 md:mx-4 shadow-[0_1px_3px_rgba(0,0,0,0.12)] p-3">
                    ...
                    <div className="flex flex-col md:flex-row border-b border-b-gray-200 pb-4 gap-3 md:gap-0">
                        <div className="w-full md:w-[45%] gap-0">
                    ...
                    <div className="font-semibold text-sm text-center my-3">Payslip for the month of May 2026</div>

                    {/* Earnings + Deductions — stack on mobile */}
                    <div className="flex flex-col md:flex-row gap-4 md:gap-10">
                        <div className="w-full md:w-[50%] flex flex-col border border-gray-200 rounded-lg">
                    ...
                    <div className="flex mt-3 mb-2 flex-wrap gap-1">
                ...
                <div className=" bottom-0 w-full bg-white h-10 border-t border-gray-200 flex justify-between items-center px-3 md:px-5 text-sm">
