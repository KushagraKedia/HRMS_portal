    ...
    return(
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="w-full bg-[#F8F9FA] text-black flex-1 h-screen overflow-y-auto">
                ...
                {/* PAGE HEADER */}
                <div className="flex flex-col md:flex-row md:h-20 mx-3 md:mx-5 py-3 md:py-0">
                    <div className="md:w-[40%] pl-0 md:pl-1 flex flex-col py-2 md:py-5 justify-between">
                        <div className="text-2xl md:text-3xl font-semibold">Employee Dashboard</div>
                    ...
                    <div className="md:w-[60%] flex items-center gap-3 md:gap-4 justify-start md:justify-end mt-3 md:mt-0 flex-wrap">
                        ...
                        <button className="bg-white rounded-lg py-2 px-3 shadow-[0_1px_3px_rgba(0,0,0,0.12)] flex items-center gap-3 hover:cursor-pointer hover:bg-orange-600 text-sm">
                ...
                {/* NOTICE BAR */}
                <div className="bg-gray-200 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] h-auto md:h-10 mx-3 md:mx-5 mt-6 flex items-center justify-between py-2 md:py-0">
                    <span className="text-gray-600 mx-3 text-sm">Your Leave Request on “24th June 2026” has been Approved!!!</span>
                    <img src={crossIcon} alt="x" className="h-7 w-7 hover:cursor-pointer mr-3 flex-shrink-0" />
                </div>


                {/* ROW 1 */}
                <div className="flex flex-col md:flex-row gap-5 mx-3 md:mx-5 my-7 items-stretch md:items-center md:h-95">

                    {/* PERSONAL DETAILS */}
                    <div className="h-auto md:h-full w-full md:w-[33%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 flex flex-col pb-4 md:pb-0">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[20%] py-3 md:py-0 bg-[#1F252D] rounded-t-lg flex gap-4 md:gap-6">
                            <img src={person11} alt="person" className="w-12 h-12 rounded-full ml-5 md:ml-7 border-3 border-white mt-1 md:mt-3" />
                        ...
                        <div className="mx-5 md:mx-7 mt-4.5 text-gray-500 text-lg">Phone Number</div>
                        <div className="mx-5 md:mx-7 text-sm">+91-9732468312</div>
                        <div className="mx-5 md:mx-7 mt-4.5 text-gray-500 text-lg">Email Address</div>
                        <div className="mx-5 md:mx-7 text-sm">devpatel1@gmail.com</div>
                        <div className="mx-5 md:mx-7 mt-4.5 text-gray-500 text-lg">Report Office</div>
                        <div className="mx-5 md:mx-7 text-sm">Doglas Martini</div>
                        <div className="mx-5 md:mx-7 mt-4.5 text-gray-500 text-lg">Joined on</div>
                        <div className="mx-5 md:mx-7 text-sm">15 Jan 2024</div>
                    </div>

                    {/* LEAVE DETAILS */}
                    <div className="h-auto md:h-full w-full md:w-[38%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[20%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Leave Details</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2 py-1 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] hover:cursor-pointer hover:bg-[#f3f0f0]">
                    ...
                    {/* LEAVE STATS */}
                    <div className="h-auto md:h-full w-full md:w-[28%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 flex flex-col pb-4 md:pb-0">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[20%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Leave Details</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2 py-1 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] hover:cursor-pointer hover:bg-[#f3f0f0]">
                        ...
                        {/* BODY */}
                        <div className="w-full h-auto md:h-[55%] flex mx-6 md:mx-8 mt-5 mb-3">
                        ...
                        <button className="h-10 text-white bg-[#1F252D] mx-6 md:mx-8 mb-3 rounded-lg hover:cursor-pointer hover:bg-black">Apply New Leave</button>
                ...
                <div className="flex flex-col md:flex-row gap-5 mx-3 md:mx-5 my-7 items-stretch md:items-center md:h-95">
                    ...
                    {/* ATTENDENCE */}
                    <div className="h-auto md:h-full w-full md:w-[33%] bg-[#FFF7ED] rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border-2 border-[#FF6B1A] flex flex-col items-center py-4 md:py-0">
                        ...
                        <button className="px-8 md:px-35 w-[80%] md:w-auto text-white font-semibold py-1 mt-2 hover:cursor-pointer hover:bg-orange-600 bg-orange-500 rounded-lg">Punch Out</button>
                    </div>

                    {/* RIGHT BOXES */}
                    <div className="h-auto md:h-full w-full md:w-[66%] flex flex-col gap-4">
                        <div className="grid grid-cols-2 md:flex md:h-[50%] gap-4">

                            {/* BOX-1 */}
                            <div className="w-full md:w-[25%] h-full bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 flex flex-col pb-3 md:pb-0">
                                <img src={ss1} alt="icon" className="h-8 w-8  mx-4 md:mx-5 mt-5 rounded-lg" />
                                <div className="flex items-center mt-3 gap-2 ml-4 md:ml-5">
                                    <span className="text-2xl font-semibold">8.36  / </span>
                                    <span className="text-2xl font-semibold text-gray-500">9</span>
                                </div>
                                <div className="font-semibold text-gray-600 mx-4 md:mx-5 mt-2 border-b border-b-gray-200 pb-2 text-sm md:text-base">Total Hours Today</div>
                                <div className="flex gap-2 mx-4 md:mx-5 mt-2 items-center">
                            ...
                            {/* BOX-2 */}
                            <div className="w-full md:w-[25%] h-full bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 pb-3 md:pb-0">
                                <img src={ss2} alt="icon" className="h-8 w-8  mx-4 md:mx-5 mt-5 rounded-lg" />
                                <div className="flex items-center mt-3 gap-2 ml-4 md:ml-5">
                                    <span className="text-2xl font-semibold">10  / </span>
                                    <span className="text-2xl font-semibold text-gray-500">40</span>
                                </div>
                                <div className="font-semibold text-gray-600 mx-4 md:mx-5 mt-2 border-b border-b-gray-200 pb-2 text-sm md:text-base">Total Hours Week</div>
                                <div className="flex gap-2 mx-4 md:mx-5 mt-2 items-center">
                                    <img src={increase} alt="icon" className="w-5 h-5 rounded-full" />
                            ...
                            {/* BOX-3 */}
                            <div className="w-full md:w-[25%] h-full bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 pb-3 md:pb-0">
                                <img src={ss3} alt="icon" className="h-8 w-8  mx-4 md:mx-5 mt-5 rounded-lg" />
                                <div className="flex items-center mt-3 gap-2 ml-4 md:ml-5">
                                    <span className="text-2xl font-semibold">75  / </span>
                                    <span className="text-2xl font-semibold text-gray-500">98</span>
                                </div>
                                <div className="font-semibold text-gray-600 mx-4 md:mx-5 mt-2 border-b border-b-gray-200 pb-2 text-sm md:text-base">Total Hours Month</div>
                                <div className="flex gap-2 mx-4 md:mx-5 mt-2 items-center">
                            ...
                            {/* BOX-4 */}
                            <div className="w-full md:w-[25%] h-full bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 pb-3 md:pb-0">
                                <img src={ss4} alt="icon" className="h-8 w-8  mx-4 md:mx-5 mt-5 rounded-lg" />
                                <div className="flex items-center mt-3 gap-2 ml-4 md:ml-5">
                                    <span className="text-2xl font-semibold">16  / </span>
                                    <span className="text-2xl font-semibold text-gray-500">28</span>
                                </div>
                                <div className="font-semibold text-gray-600 mx-4 md:mx-5 mt-2 border-b border-b-gray-200 pb-2 text-sm">Overtime this Month</div>
                                <div className="flex gap-2 mx-4 md:mx-5 mt-2 items-center">
                                    <img src={decrease} alt="icon" className="w-5 h-5 rounded-full" />
                        ...
                        {/* LONG BOX */}
                        <div className="w-full bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 h-auto md:h-[50%]">
                            <WorkHoursTimeline />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-5 mx-3 md:mx-5 my-7 items-stretch md:items-center md:h-95">
                    {/* PROJECTS */}
                    <div className="h-auto md:h-full w-full md:w-[50%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[20%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Projects</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 py-1 rounded-lg px-3 hover:cursor-pointer hover:bg-[#f3f0f0]">
                                <span className="text-sm md:text-base">Ongoing Projects</span>
                            </button>
                        </div>    
                            {/* BODY */}
                            <div className="flex flex-col md:flex-row gap-4 p-4 h-auto md:h-[80%]">
                                <div className="w-full md:w-[50%] h-full border border-gray-200 rounded-lg px-3 py-3 md:py-0 flex flex-col gap-3 md:gap-0 md:justify-evenly">
                                    ...
                                    <div className="flex items-center gap-1.5 w-full bg-gray-100 py-1 rounded border border-dashed border-gray-300">
                                        ...
                                        <img src={users} alt="icon" className="w-5 h-5 ml-auto mr-2" />
                                    </div>
                    ...
                    <div className="h-auto md:h-full w-full md:w-[50%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[20%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Tasks</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 py-1 rounded-lg px-3 hover:cursor-pointer hover:bg-[#f3f0f0]">
                                <span className="text-sm md:text-base">All Projects</span>
                            </button>
                        </div>
                        {/* BODY */}
                        <div className="flex flex-col h-auto md:h-[80%] justify-evenly gap-3 px-3 md:px-5 py-3">
                            {/* ROW-1 */}
                            <div className="w-full border rounded-lg border-gray-300 h-auto flex items-center flex-wrap gap-2 py-2 px-4">
                                <img src={grid} alt="grid" className="w-4 h-4 hidden md:block" />
                                <button onClick={() => setChecked(!checked)} className={`w-4 h-4 border md:mx-3 rounded-md flex items-center justify-center transition-all ${checked ? "bg-orange-500 text-white" : "border-gray-300 bg-white" }`}>
                                    {checked && "✓"}</button>
                                <img src={star} alt="star" className="w-4 h-4 hover:cursor-pointer" />
                                <span className="font-semibold text-sm">Patient appointment booking</span>
                                <span className="bg-[#FFDBEC] text-[#FD3995] px-3 py-1 md:ml-25 rounded-lg text-xs font-semibold">● Onhold</span>
                                <img src={users} alt="icon" className="w-5 h-5 md:ml-7 hover:cursor-pointer" />
                            </div>
                            {/* ROW-2 */}
                            <div className="w-full border rounded-lg border-gray-300 h-auto flex items-center flex-wrap gap-2 py-2 px-4">
                                <img src={grid} alt="grid" className="w-4 h-4 hidden md:block" />
                                <button onClick={() => setChecked(!checked)} className={`w-4 h-4 border md:mx-3 rounded-md flex items-center justify-center transition-all ${checked ? "bg-orange-500 text-white" : "border-gray-300 bg-white" }`}>
                                    {checked && "✓"}</button>
                                <img src={star} alt="star" className="w-4 h-4 hover:cursor-pointer" />
                                <span className="font-semibold text-sm">Appointment booking with payment</span>
                                <span className="bg-[#F7EEF9] text-[#AB47BC] px-3 py-1 md:ml-14 rounded-lg text-xs font-semibold">● Inprogress</span>
                                <img src={users} alt="icon" className="w-5 h-5 md:ml-3 hover:cursor-pointer" />
                            </div>
                            {/* ROW-3 */}
                            <div className="w-full border rounded-lg border-gray-300 h-auto flex items-center flex-wrap gap-2 py-2 px-4">
                                <img src={grid} alt="grid" className="w-4 h-4 hidden md:block" />
                                <button onClick={() => setChecked(!checked)} className={`w-4 h-4 border md:mx-3 rounded-md flex items-center justify-center transition-all ${checked ? "bg-orange-500 text-white" : "border-gray-300 bg-white" }`}>
                                    {checked && "✓"}</button>
                                <img src={star} alt="star" className="w-4 h-4 hover:cursor-pointer" />
                                <span className="font-semibold text-sm">Patient and Doctor video conferencing</span>
                                <span className="bg-[#E5F9EE] text-[#03C95A] px-3 py-1 md:ml-11 rounded-lg text-xs font-semibold">● Completed</span>
                                <img src={users} alt="icon" className="w-5 h-5 md:ml-2 hover:cursor-pointer" />
                            </div>
                            {/* ROW-4 */}
                            <div className="w-full border rounded-lg border-gray-300 h-auto flex items-center flex-wrap gap-2 py-2 px-4">
                                <img src={grid} alt="grid" className="w-4 h-4 hidden md:block" />
                                <button onClick={() => setChecked(!checked)} className={`w-4 h-4 border md:mx-3 rounded-md flex items-center justify-center transition-all ${checked ? "bg-orange-500 text-white" : "border-gray-300 bg-white" }`}>
                                    {checked && "✓"}</button>
                                <img src={star} alt="star" className="w-4 h-4 hover:cursor-pointer" />
                                <span className="font-semibold text-sm">Private chat module</span>
                                <span className="bg-[#EDF2F4] text-[#0C4B5E] px-3 py-1 md:ml-41 rounded-lg text-xs font-semibold">● Pending</span>
                                <img src={users} alt="icon" className="w-5 h-5 md:ml-5 hover:cursor-pointer" />
                            </div>
                            {/* ROW-5 */}
                            <div className="w-full border rounded-lg border-gray-300 h-auto flex items-center flex-wrap gap-2 py-2 px-4">
                                <img src={grid} alt="grid" className="w-4 h-4 hidden md:block" />
                                <button onClick={() => setChecked(!checked)} className={`w-4 h-4 border md:mx-3 rounded-md flex items-center justify-center transition-all ${checked ? "bg-orange-500 text-white" : "border-gray-300 bg-white" }`}>
                                    {checked && "✓"}</button>
                                <img src={star} alt="star" className="w-4 h-4 hover:cursor-pointer" />
                                <span className="font-semibold text-sm">Go-Live and Post-Implementation Support</span>
                                <span className="bg-[#F7EEF9] text-[#AB47BC] px-3 py-1 md:ml-6 rounded-lg text-xs font-semibold">● Inprogress</span>
                                <img src={users} alt="icon" className="w-5 h-5 md:ml-2 hover:cursor-pointer" />
                            </div>
                        </div>
                    </div>
                ...
                {/* FOURTH ROW */}
                <div className="flex flex-col md:flex-row gap-5 mx-3 md:mx-5 my-7 items-stretch md:items-center md:h-105">

                    {/* PERFORMANCE */}
                    <div className="h-auto md:h-full w-full md:w-[40%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[17%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Performance</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2 py-1 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] hover:cursor-pointer hover:bg-[#f3f0f0]">
                                <img src={calendarIcon} alt="icon" className="w-4 h-4" />
                                <span>2026</span>
                            </button>
                    ...
                    {/* MY SKILLS */}
                    <div className="h-auto md:h-full w-full md:w-[35%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[17%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">My Skills</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2 py-1 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] hover:cursor-pointer hover:bg-[#f3f0f0]">
                                <img src={calendarIcon} alt="icon" className="w-4 h-4" />
                                <span>2026</span>
                            </button>
                        ...
                        {/* BODY */}
                        <div className="flex flex-col gap-2 md:gap-0 md:justify-evenly h-auto md:h-[82%] mx-4 py-4 md:py-0">
                    ...
                    {/* THREE BOXES */}
                    <div className="h-auto md:h-full w-full md:w-[29%] flex flex-col gap-4">

                        {/* BIRTHDAY BOX */}
                        <div className="w-full h-auto md:h-[60%] py-6 md:py-0 bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 flex flex-col items-center bg-cover bg-center" style={{backgroundImage: `url(${bg1})`,}}>
                        ...
                        {/* LEAVE POLICY */}
                        <div className="w-full h-auto md:h-[20%] py-4 md:py-0 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 flex items-center justify-between bg-[#0C4B5E]">
                            ...
                            <button className="flex items-center gap-2.5 mr-6 md:m-6 bg-white px-2.5 py-1 rounded-lg hover:cursor-pointer hover:bg-orange-400 hover:text-white">
                                <span className="font-semibold text-sm">View All</span>
                            </button>
                        </div>

                        {/* HOLDIDAY BOX */}
                        <div className="w-full h-auto md:h-[20%] py-4 md:py-0 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300 flex items-center justify-between bg-[#FFC107]">
                            <div className="flex flex-col w-[55%] ml-6">
                ...
                {/* FIFTH ROW */}
                <div className="flex flex-col md:flex-row gap-5 mx-3 md:mx-5 my-7 items-stretch md:items-center md:h-110">

                    {/* TEAM MEMBERS */}
                    <div className="h-auto md:h-full w-full md:w-[33%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[17%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Team Members</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2.5 py-1 rounded-lg hover:cursor-pointer hover:bg-[#f3f0f0] bg-[#d0d0d0]">
                                <span className="font-semibold text-sm">View All</span>
                            </button>
                        </div>
                        {/* BODY */}
                        <div className="flex flex-col gap-3 md:gap-0 md:justify-around mx-4 md:mx-6 h-auto md:h-[83%] py-4 md:py-0">
                            {/* ROW-1 */}
                    ...
                    <div className="h-auto md:h-full w-full md:w-[33%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[17%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Notifications</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2.5 py-1 rounded-lg hover:cursor-pointer hover:bg-[#f3f0f0] bg-[#ded5d5]">
                                <span className="font-semibold text-sm">View All</span>
                            </button>
                        </div>
                        {/* BODY */}
                        ...
                        <div className="flex gap-2 items-center">
                            <img src={noti_img} alt="image" className="h-6 w-6 rounded-lg border-2 border-gray-300 mt-2 ml-11 md:ml-12" />
                            <span className="hover:pointer-cursor hover:text-orange-500 mt-1 text-sm">EY_review.pdf</span>
                        </div>
                        {/* NOTI-2 */}
                        ...
                        <div className="flex items-center gap-2">
                            <button className="text-white px-2.5 text-sm py-1 h-auto bg-orange-500 rounded-lg mt-2 ml-12 md:ml-15 hover:cursor-pointer hover:bg-orange-600">Approve</button>
                    ...
                    <div className="h-auto md:h-full w-full md:w-[33%] bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] border border-gray-300">
                        {/* HEADING */}
                        <div className="w-full h-auto md:h-[17%] py-3 md:py-0 rounded-t-lg flex gap-6 border-b border-b-gray-200 items-center justify-between">
                            <span className="pl-5 md:p-5 text-xl font-semibold">Meeting Schedule</span>
                            <button className="flex items-center gap-2.5 mr-5 md:m-6 border border-gray-300 px-2 py-1 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.12)] hover:cursor-pointer hover:bg-[#f3f0f0]">
                                <img src={calendarIcon} alt="icon" className="w-4 h-4" />
                                <span>Today</span>
                            </button>
                        ...
                        {/* BODY */}
                        <div className="flex mt-5 mx-4 pb-4 md:pb-0 gap-2">
                            <div className="w-[28%] sm:w-[30%] mr-2 sm:mr-4 mt-4 self-stretch">
                                <div className="h-full flex flex-col justify-between relative">
                                <div className="absolute left-[58px] sm:left-[78px] top-2 bottom-2 border-r border-dashed border-gray-300 z-0"></div>
                                <div className="flex items-center relative z-10">
                                  <span className="text-gray-500 text-xs sm:text-sm w-[55px] sm:w-[75px]">12:25 AM</span>
                                  <div className="w-3 h-3 rounded-full bg-[#F97316] flex-shrink-0"></div>
                                </div>
                                <div className="flex items-center relative z-10">
                                  <span className="text-gray-500 text-xs sm:text-sm w-[55px] sm:w-[75px]">11:20 AM</span>
                                  <div className="w-3 h-3 rounded-full bg-[#0C4B5E] flex-shrink-0"></div>
                                </div>
                                <div className="flex items-center relative z-10">
                                  <span className="text-gray-500 text-xs sm:text-sm w-[55px] sm:w-[75px]">10:18 AM</span>
                                  <div className="w-3 h-3 rounded-full bg-[#F4B400] flex-shrink-0"></div>
                                </div>
                                <div className="flex items-center relative z-10">
                                  <span className="text-gray-500 text-xs sm:text-sm w-[55px] sm:w-[75px]">09:10 AM</span>
                                  <div className="w-3 h-3 rounded-full bg-[#03C95A] flex-shrink-0"></div>
                                </div>
                            </div>
                            </div>
                            <div className="w-[72%] sm:w-[70%] flex flex-col gap-4 md:gap-6">
                ...
                <div className="flex bg-white border-t border-t-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.12)] mt-0 justify-between p-2 w-auto text-sm">
